...
public class Cycle_User_Two extends Driver_Setup {
    ...
    public static void userLoginAndCheckout() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@id='email']")).sendKeys("soliman15-8572@diu.edu.bd");
        driver.findElement(By.xpath("//input[@id='passwd']")).sendKeys("87654321");
        driver.findElement(By.xpath("//span[normalize-space()='Sign in']")).click();
        Thread.sleep(2000);

        String actualName = "Soliman Ali";
