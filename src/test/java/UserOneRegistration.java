...
public class UserOneRegistration extends Driver_Setup {
    ...
    public static void registration() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[contains(@id,'email_create')]")).sendKeys("ashikur15-8763@diu.edu.bd");
        driver.findElement(By.xpath("//button[contains(@id,'SubmitCreate')]")).click();
        Thread.sleep(2000);

        // (First name, Last name, Password)
        driver.findElement(By.xpath("//input[contains(@id,'customer_firstname')]")).sendKeys("Ashibur");
        driver.findElement(By.xpath("//input[contains(@id,'customer_lastname')]")).sendKeys("Rahman");
        driver.findElement(By.xpath("//input[contains(@id,'passwd')]")).sendKeys("12345678");
        ...
        driver.findElement(By.xpath("//input[contains(@id,'address1')]")).sendKeys("332/1A, Mirpur,Dhaka");
